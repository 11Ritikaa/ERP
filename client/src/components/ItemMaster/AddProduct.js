...
const AddProduct = () => {
  const [formData, setFormData] = useState(() => {
    ...
    return savedData
      ...
      : {
          ...
          etsystore1price: 0,
          etsystore2price: 0,
          shopifystore1price: 0,
          shopifystore2price: 0,
          hsn: '',
          status: 'ACTIVE',
          gstSlab: 5,
          setOf: '',
  ...
  const handleBulkImageUpload = () => {
    ...
    toast.info('Bulk Image Upload clicked')
  }

  const handleBulkUpload = () => {
    // Implement bulk upload functionality
    toast.info('Bulk Upload clicked')
  }
  ...
  return (
    <>
      ...
      <CForm className="row g-3" onSubmit={handleSubmit}>
        {/* Product Name and SKU - Vertical Alignment */}
        <CRow className="mb-3">
          <CCol md={6}>
            <div className="d-flex flex-column">
              <CFormLabel className="mb-2">
                {renderLabel('Product Name', 'productName')}
              </CFormLabel>
              <CFormInput
                type="text"
                id="productName"
        ...
        <CRow>
          <CCol md={6}>
            <CFormLabel>{renderLabel('Variation Name', 'variationName')}</CFormLabel>
            <CFormInput
              type="text"
              id="variationName"
              name="variationName"
              ...
              onChange={handleChange}
              className={errors.variationName ? 'is-invalid' : ''}
            />
            {errors.variationName && (
              <div style={{ color: 'red', fontSize: '0.875rem' }}>{errors.variationName}</div>
            )}
          </CCol>
        </CRow>
        ...
        <CRow>
          ...
          <CCol md={2}>
            ...
            />
            {errors.width && (
              <div style={{ color: 'red', fontSize: '0.875rem' }}>{errors.width}</div>
            )}
          </CCol>
          <CCol md={2}>
        ...
        <CCol md={4}>
          <CFormLabel>{renderLabel('GST Slab', 'gstSlab')}</CFormLabel>
          <CFormSelect
            id="gstSlab"
            name="gstSlab"
            value={formData.gstSlab}
            onChange={handleChange}
            className={errors.gstSlab ? 'is-invalid' : ''}
          >
          ...
          {errors.gstSlab && (
            <div style={{ color: 'red', fontSize: '0.875rem' }}>{errors.gstSlab}</div>
          )}
        </CCol>
        <CCol md={4}>
