...
import { CCard, CCardBody, CCardHeader, CRow, CCol, CButton, CTable, CTableHead, CTableRow, CTableHeaderCell, CTableBody, CTableDataCell } from '@coreui/react';
    ...
    <>
      <CCard className="mb-4">
        <CCardHeader>
          ...
          >
            <FontAwesomeIcon icon={viewMode === 'grid' ? faTable : faTh} /> {viewMode === 'grid' ? 'Table View' : 'Grid View'}
          </CButton>
        </CCardHeader>
        <CCardBody>
          {viewMode === 'grid' ? (
